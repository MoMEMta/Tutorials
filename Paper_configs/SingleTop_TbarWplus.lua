load_modules('MatrixElements/ME_gbx_txw_mum_mup/libme_ME_gbx_txw_mum_mup.so')
...
parameters = {
    ...
    ME_card = 'MatrixElements/ME_gbx_txw_mum_mup/Cards/param_card.dat',
}
...
Looper.looper_sb_b = {
    ...
    Looper.looper_blockb = {
        ...
        path = Path("boost", "tbarwPlus", "integrand")
    }
        ...
        MatrixElement.tbarwPlus = {
          pdf = 'CT10nlo',
          pdf_scale = parameter('top_mass'),

          matrix_element = 'ME_gbx_txw_mum_mup_sm_no_b_mass',
